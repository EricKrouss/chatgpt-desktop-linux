...
test("handles namespace constants in the current Chrome plugin gate", () => {
  const source = [
    "var bs=[",
    "{name:o.s,syncInstallStateWithChromeExtension:!0,isAvailable:({buildFlavor:e,env:t,features:n})=>o.i(e,t)&&n.externalBrowserUseAllowed},",
    "{name:n.Cs,syncInstallStateWithChromeExtension:!0,isAvailable:({buildFlavor:e,env:t,features:n})=>o.a(e,t)&&n.externalBrowserUseAllowed},",
    "{name:o.c,syncInstallStateWithChromeExtension:!0,isAvailable:({buildFlavor:e,features:t})=>t.externalBrowserUseAllowed&&o.o(e)}",
  ...
  assert.match(
    patched,
    /installWhenMissing:!0,name:o\.c,syncInstallStateWithChromeExtension:!0,isAvailable:\(\{buildFlavor:e,features:t\}\)=>process\.platform===`linux`\|\|\(t\.externalBrowserUseAllowed&&o\.o\(e\)\)/,
  );
  assert.doesNotMatch(patched, /installWhenMissing:!0,name:o\.s/);
  assert.doesNotMatch(patched, /installWhenMissing:!0,name:n\.Cs/);
});
