...
JSON
    ...
    assert_file_exists "$root/opt/chatgpt-desktop/update-builder/scripts/lib/upstream-dmg-intel.js"
    ...
    assert_contains "$update_builder_manifest" "scripts/lib/upstream-dmg-intel.js"
...
test_linux_file_manager_patch_smoke() {
    ...
    assert_contains "$extracted/.vite/build/main-test.js" 'process.platform===`linux`&&D.removeMenu(),process.platform===`win32`&&D.remo